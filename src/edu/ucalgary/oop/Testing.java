...
public class Testing {
    ...
    public void SpeciesExceptionTest() {
        ...
        try {
            Animal animal = new Animal(20, "Smarty pants", Species.valueOf("ELEPHANT"));
        }
        catch(NotSpeciesException e) {
            passed = true;
            assertEquals("Invalid species, must be one of FOX, RACCOON, BEAVER, COYOTE, PORCUPINE", e.getMessage());
        }
        assertTrue(passed);
    }
